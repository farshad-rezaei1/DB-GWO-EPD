...
% function [fobj]=Objective_Function_DB_GWO_EPD(x,fhd,varargin) % Only for CEC2017 
% fobj=feval(fhd,x',varargin{:});   
% end
function [lb,ub,dim,fobj]=Objective_Function_DB_GWO_EPD(F) 
switch F
    case 'F1'
        fobj = @F1;
        lb=-100;
